...
Multics Compose, developed  at MIT and Honeywell between 1972 and 1985, processed source files containing text and control commands (dot commands) to produce formatted output for terminals, printers, and phototypesetters. 
