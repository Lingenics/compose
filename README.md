...
This project recovers Compose, and extends the system with block templates, style classes, and Unicode mathematics ISO 80000-2 typography. Unlike most such formats (LaTeX comes to mind) a Compose file is readable without rendering.
